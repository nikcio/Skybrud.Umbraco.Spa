...
namespace Skybrud.Umbraco.Spa.Repositories
{
    ...
    public class SpaDomainRepository {
        ...
        public SpaDomainRepository(IPublishedSnapshotAccessor publishedSnapshotAccessor, ISiteDomainMapper siteDomainHelper) {
        ...
        public DomainAndUri DomainForNode(int nodeId, Uri current, string culture = null) {
            ...
            var domains = publishedSnapshot.Domains.GetAssigned(nodeId).ToArray();
            ...
            return SelectDomain(domains, current, culture, publishedSnapshot.Domains.DefaultCulture, _siteDomainHelper.MapDomain);
        ...
        public bool FindDomain(SpaRequest request, Uri uri) {
            ...
            if (request.Arguments.PageId > 0) {
                ...
                IPublishedContent c = publishedSnapshot.Content.GetById(request.Arguments.PageId);
            ...
            var domainsCache =  publishedSnapshot.Domains;
            ...
            bool IsPublishedContentDomain(Domain domain) {
                ...
                var domainDocument = publishedSnapshot.Content.GetById(domain.ContentId);
                ...
                if (domainDocument.ContentType.Variations == 0)
                    return true;
